...
export interface paths {
    ...
    "/notams": {
        ...
        /** @description Get a list of NOTAMs. */
    ...
    "/notams/{notamId}": {
        ...
        /** @description Get a NOTAM by ID. */
        get: operations["Notams_get"];
        put?: never;
        post?: never;
        /** @description Delete a NOTAM by ID. */
        delete: operations["Notams_delete"];
        options?: never;
        head?: never;
        /** @description Update a NOTAM. */
    ...
    "/users/{userId}/refreshApiKey": {
        ...
        get?: never;
        put?: never;
        /** @description Refresh the API key for a user. */
        post: operations["Users_refreshApiKey"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        Airport: {
            ...
            timezone?: string;
            facilityType?: components["schemas"]["FACILITY_TYPE"];
            isPrivate?: boolean;
            isClosed?: boolean;
        ...
        Runway: {
            ...
            lowEndIdent?: string;
            /** Format: int32 */
            lowEndElevation?: number;
            /** Format: int32 */
            lowEndHeading?: number;
            /** Format: int32 */
            lowEndDisplacedThreshold?: number;
            /** Format: float */
            lowEndLatitude?: number;
            /** Format: float */
            lowEndLongitude?: number;
            highEndIdent?: string;
            /** Format: int32 */
            highEndElevation?: number;
            /** Format: int32 */
            highEndHeading?: number;
            /** Format: int32 */
            highEndDisplacedThreshold?: number;
            /** Format: float */
            highEndLatitude?: number;
            /** Format: float */
            highEndLongitude?: number;
        };
        UnauthorizedError: {
            /** @enum {number} */
            statusCode: 401;
